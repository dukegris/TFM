  ...
  // spark-shell --packages com.johnsnowlabs.nlp:spark-nlp_2.11:2.5.5,org.slf4j:slf4j-log4j12:1.7.28 --jars es.rcs.tfm.nlp/target/RCS-Nlp-0.0.4-SNAPSHOT.jar --executor-memory=32g --executor-cores=6 --driver-memory=24g --conf "spark.executor.extraJavaOptions='-Dlog4j.configuration=/opt/spark/conf/log4j.properties'" --conf "spark.driver.maxResultSize=8g" > train_albert.log
  ...
  */
  ...
  //  	Array("albert_large_uncased_en_2.5.0_2.4_1588073397355", 1024, 128),
    ...
    Array("albert_xxlarge_uncased_en_2.5.0_2.4_1588073443653", 4096, 128)
