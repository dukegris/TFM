...
val pos = PerceptronModel.
	load("file://" + CORPUS_DIR + "/models/pos/pos_anc_en_2.0.2_2.4_1556659930154").
...
//	setCaseSensitive(true).
	load("file://" + CORPUS_DIR + "/models/bert/bert_large_uncased_en_2.4.0_2.4_1580581306683").
	setDimension(1024).
	setMaxSentenceLength(512).
	setBatchSize(256).
...
val albertembeddings = AlbertEmbeddings.
//	load("file://" + CORPUS_DIR + "/models/bert/albert_base_uncased_en_2.5.0_2.4_1588073363475").
//	setDimension(768).
//	setMaxSentenceLength(512).
//	setBatchSize(256).
//	setCaseSensitive(true).
//	load("file://" + CORPUS_DIR + "/models/bert/albert_xxlarge_uncased_en_2.5.0_2.4_1588073588232").
	load("file://" + CORPUS_DIR + "/models/bert/albert_xxlarge_uncased_en_2.5.0_2.4_1588073588232").
	setDimension(1024).
	setMaxSentenceLength(512).
	setBatchSize(256).
...
//	load("file://" + CORPUS_DIR + "/models/ner/ner_dl_en_2.4.0_2.4_1580251789753").
//	load("file://" + CORPUS_DIR + "/models/ner/ner_dl_en_2.4.0_2.4_1580251789753").
	load("file://" + CORPUS_DIR + "/models/ner/ner_dl_en_2.4.0_2.4_1580251789753").
...
val trainingConll=embeddings.transform(CoNLL().readDataset(
	spark,
		"file://" + CORPUS_DIR + "/training/conll/eng.train_testb.conll"))
//	"file://" + CORPUS_DIR + "/training/conll/eng.train_testb.conll"))
...
val testConll=embeddings.transform(CoNLL().readDataset(
	spark,
		"file://" + CORPUS_DIR + "/training/conll/eng.testa.conll"))
//	"file://" + CORPUS_DIR + "/training/conll/eng.testa.conll"))
...
testConll.
	write.
	mode("overwrite").
	parquet("file://" + CORPUS_DIR + "/training/tmp/eng.testa.conll.parquet")
//	parquet("file://" + CORPUS_DIR + "/training/tmp/eng.testa.conll.parquet")
...
val nerApproach = new NerDLApproach().
	setTestDataset("file://" + CORPUS_DIR + "/training/tmp/eng.testa.conll.parquet").
//	setTestDataset("file://" + CORPUS_DIR + "/training/tmp/eng.testa.conll.parquet").
//	setTestDataset("file://" + CORPUS_DIR + "/training/tmp/ner_bioc_test.conll.parquet").
//	setTestDataset("file://" + CORPUS_DIR + "/training/tmp/ner_txt.conll.parquet").
	setInputCols(Array("sentence", "token", "embeddings")).
...
nerTagger.write.
	overwrite.
	save(CORPUS_DIR + "/models/ner/tfm_ner_english_M-512_B-256_albert_xxlarge_uncased_en")
//	save("/" + CORPUS_DIR + "/models/ner/tfm_ner_english_M-512_B-256_bert_large_uncased_en")
...
ner.write.
	overwrite.
	save(CORPUS_DIR + "/models/ner/tfm_ner_english_M-512_B-256_albert_xxlarge_uncased_en_desdepipeline")
//	save("/" + CORPUS_DIR + "/models/ner/tfm_ner_english_M-512_B-256_bert_large_uncased_en_desdepipeline")
//	save("/" + CORPUS_DIR + "/models/ner/tfm_ner_english_M-512_B-256_bert_large_uncased_en_desdepipeline")
